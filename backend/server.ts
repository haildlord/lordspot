...
app.post('/crank', async (req: Request, res: Response): Promise<any> => {
    ...
    if (timeSinceLastCrank < CRANK_COOLDOWN_MS) {
        console.log(`[CRANK GUARD] COOLDOWN ACTIVE. Denying request. Time left: ${((CRANK_COOLDOWN_MS - timeSinceLastCrank) / 1000).toFixed(1)}s`);
        console.log(`==================================================\n`);
    ...
    if (isCrankInProgress) {
        console.log(`[CRANK GUARD] STAMPEDE AVERTED: Crank already running. Rejecting duplicate request.`);
        console.log(`==================================================\n`);
    ...
    try {
        ...
        console.log(`[CRANK] Initializing Programs...`);
        ...
        console.log(`[STATE] CURRENT EPOCH ON-CHAIN IS: ${currentEpochId}`);
        ...
        if (!currentDrawingState.lordspotLock) {
            ...
            try {
                ...
                console.log(`[PHASE 1] Sleeping for 8 seconds to allow Switchboard Oracle to resolve on-chain...`);
                ...
                if (errMsg.includes("6048")) {
                    console.error(`[PHASE 1 REJECTED] Program rejected commit: Minimum drawing time not reached yet (Custom 6048).`);
        ...
        if (currentDrawingState.winningTicket.toNumber() === 0) {
            ...
            try {
                ...
                console.log(`[TX] Compiling and signing Phase 2 Versioned Transaction...`);
        ...
        try {
            ...
            console.log(`[TX] Compiling and signing Phase 3 Versioned Transaction...`);
            ...
            console.log(`[CRANK] Epoch Timer Locked for 60 seconds.`);
